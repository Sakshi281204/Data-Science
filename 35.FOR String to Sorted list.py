...
letter_count = {} # in this variable we have declare a empty dictionary in which we are going to get a letter and number of repetition 
...
for i in letter_count: #in this line we will go through all the elemnts in the dictionary
...
for i in range(len(a)):#in this for will go through all the elements in the  list
    mvi=i #here we have minimum value index as i as the i changes mvi also going to change
